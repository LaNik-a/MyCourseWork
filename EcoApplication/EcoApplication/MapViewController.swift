...
class MapViewController: UIViewController {
    ...
    let trashcan = Trashcan(coordinate: CLLocationCoordinate2D(latitude: 55.7564540 , longitude: 37.6182540), name: "Моя первая мусорка")
    ...
    override func viewDidLoad() {
        ...
        // Отображаем нашу созданную мусорку
        mapView.addAnnotation(trashcan)
...
extension MapViewController:MKMapViewDelegate{
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        guard let annotation = annotation as? Trashcan else { return nil }
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        let trashcan = view.annotation as! Trashcan
